      ...
      <section className="about-hero">
        <div className="container">
          <div className="about-hero-content">
            ...
            <h1>{get('about.hero.heading', 'About KarOrganicsUganda')}</h1>
        ...
        <div className="container">
          <div className="about-grid">
            <div className="about-story-content">
              ...
              <p>{get('about.story.body', 'KarOrganicsUganda was born from a simple belief: the herbs that have sustained East African communities for generations deserve to be shared with the world - pure, potent, and properly honored.')}</p>
            </div>
